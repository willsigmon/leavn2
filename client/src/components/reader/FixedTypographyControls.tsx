...
import { FontFamily, FontSize, LineSpacing, TextAlignment, MarginSize } from '@/lib/readerStore';
...
export function TypographyControls() {
  ...
  const textAlignments: {value: TextAlignment, label: string}[] = [
    { value: 'left', label: 'Left' },
    { value: 'justify', label: 'Justify' },
    { value: 'center', label: 'Center' },
  ];

  const marginSizes: {value: MarginSize, label: string}[] = [
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                value={fontFamily}
                onValueChange={(value: FontFamily) => setTypographySettings({ fontFamily: value })}
              >
                <SelectTrigger 
                  id="font-family"
            ...
            <div className="space-y-2">
              ...
              <Select
                value={lineSpacing}
                onValueChange={(value: LineSpacing) => setTypographySettings({ lineSpacing: value })}
              >
                <SelectTrigger 
                  id="line-spacing"
                  className="w-full h-9 border-stone-200 dark:border-stone-700 focus:ring-[#2c4c3b] dark:focus:ring-[#94b49f]"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                value={textAlignment}
                onValueChange={(value: TextAlignment) => setTypographySettings({ textAlignment: value })}
              >
                <SelectTrigger 
                  id="text-alignment"
                  className="w-full h-9 border-stone-200 dark:border-stone-700 focus:ring-[#2c4c3b] dark:focus:ring-[#94b49f]"
            ...
            <div className="space-y-2">
              ...
              <Select
                value={marginSize}
                onValueChange={(value: MarginSize) => setTypographySettings({ marginSize: value })}
              >
                <SelectTrigger 
                  id="margin-size"
                  className="w-full h-9 border-stone-200 dark:border-stone-700 focus:ring-[#2c4c3b] dark:focus:ring-[#94b49f]"
